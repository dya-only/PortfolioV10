  ...
  return (
    <nav className='fixed z-50 w-screen h-[100px] flex justify-around items-start'>
      <div className="flex justify-start items-start w-[900px]">
        ...
        <div id={menu ? 'menu-on' : 'menu-off'} className='-z-10 -ml-14 p-4 w-72 h-14 rounded-br-3xl rounded-bl-[30px] bg-white/70 backdrop-blur-2xl drop-shadow-xl flex justify-end items-center'>
