  ...
  return (!props.dir ?
      <div id='award1' className='flex mb-12 z-20'>
        ...
        <div className='flex flex-col justify-center items-start sm:ml-0 xs:ml-8 lg:ml-8 md:ml-8'>
          ...
          { props.type === 2 ? <span className='w-10 h-1 bg-gradient-to-r from-cyan-400 to-pink-300 rounded-full'/> : null }
          { props.type === 3 ? <span className='w-16 h-1 bg-gradient-to-r from-cyan-400 to-pink-300 rounded-full'/> : null }
          { props.type === 4 ? <span className='w-40 h-1 bg-gradient-to-r from-cyan-400 to-pink-300 rounded-full'/> : null }
